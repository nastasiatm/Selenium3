...
public class Message {
    ...
    public void testLoginChrome() throws Exception {
        ...
        driver.get(baseUrl + "/#");
        driver.findElement(By.xpath("//*[contains(@alt,'Поиск')]")).click();
        driver.findElement(By.xpath("//input[contains(@name,'query')]")).sendKeys("игра");
        driver.findElement(By.xpath("//*[contains(@alt,'Search')]")).click();
        Thread.sleep(2000);
        Assert.assertEquals("Chrome 'nastasiatm' page wasn't loaded",
                "Search results for 'игра' - Wikia | Fandom powered by Wikia", driver.getTitle());
    }
