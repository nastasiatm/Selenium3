 ...
 */
public class GooglePlay { ///html/body/footer/div[1]/div[3]/section[5]/ul/li[2]/a/svg/use
    WebDriver driver;
    ...
    public void testAboutFireFox() throws Exception {
        ...
        driver.get(baseUrl + "/#");
        driver.findElement(By.xpath("/html/body/footer/div[1]/div[3]/section[5]/ul/li[2]/a")).click();
        Thread.sleep(10000);
        Assert.assertEquals("FireFox 'about page wasn't loaded",
                "Приложения в Google Play – Fandom powered by Wikia", driver.getTitle());
    }
