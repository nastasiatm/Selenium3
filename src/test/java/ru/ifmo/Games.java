...
public class Games {
    ...
    public void testAboutFireFox() throws Exception {
        ...
        driver.get(baseUrl + "/#");
        driver.findElement(By.xpath("/html/body/section[3]/div[2]/div[1]")).click();
        Thread.sleep(1000);
    }

    @Test
    public void testGamesChrome() throws Exception {
        ...
        //        "Injustice вики | Fandom powered by Wikia", driver.getTitle());
    }
