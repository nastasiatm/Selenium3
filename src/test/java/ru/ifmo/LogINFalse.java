...
public class LogINFalse {
    ...
    public void testLoginChrome() throws Exception {
        ...
        Assert.assertEquals("Chrome 'about' page wasn't loaded",
                "Войти | Fandom powered by Wikia", driver.getTitle());
        driver.findElement(By.xpath("//input[contains(@name,'username')]")).sendKeys("nastasia");
        ...
        Assert.assertEquals("Chrome 'explore' page wasn't loaded",
                "Мы не можем распознать эти учётные данные. Пожалуйста, попробуйте снова или зарегистрируйте новый аккаунт.",
    ...
    public void testLoginFirefox() throws Exception {
        ...
        Assert.assertEquals("Chrome 'explore' page wasn't loaded",
                "Мы не можем распознать эти учётные данные. Пожалуйста, попробуйте снова или зарегистрируйте новый аккаунт.",
                driver.findElement(By.xpath("//small[contains(@class,'error')]")).getText().toString()); //"//*[@id='loginForm']/small"
